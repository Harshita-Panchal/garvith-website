...
{/* bg-[#96775F] */}
        <div className="max-w-[1140px] mx-auto py-8 bg-light-gray rounded-2xl shadow-[0_0_9px_2px_rgba(0,0,0,0.15)]">
          <p className="text-primary-blue  text-center pb-8 text-6xl font-bold">
            About
          </p>
          <p className="text-primary-blue font-medium bg-white py-2 text-center text-2xl ">
            Gopal Garvith
          </p>
          <div className="flex p-10 pt-16">
            ...
            <div className="bg-white p-12 rounded-2xl max-w-xl relative right-8 top-8">
              <h3 className="text-2xl mb-3 text-primary-blue font-bold">
                Joyful, Curious, Innocent
              </h3>
              <p className="font-semibold text-base">
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Iusto
                sit, veritatis ducimus velit, a, saepe distinctio tenetur
                exercitationem placeat ipsam sequi ipsum corporis aliquam ut
                voluptates tempore perspiciatis corrupti animi.
              </p>
            </div>
          </div>
          <div className="flex p-10 pt-16">
